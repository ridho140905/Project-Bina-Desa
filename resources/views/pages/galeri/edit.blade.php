        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="field">
              ...
              @if($fotoUtama)
                <div class="mb-3">
                  <p class="text-sm text-muted mb-2">Foto Utama Saat Ini:</p>
                  ...
                  <p class="text-xs text-muted mt-1">{{ $fotoUtama->file_name }}</p>
                </div>
              @endif
              ...
              <small class="form-text text-muted">
                Biarkan kosong jika tidak ingin mengubah foto utama. Format: JPG, JPEG, PNG, GIF, WEBP. Maksimal 5MB.
              </small>
              @error('foto_utama')
                <p class="help is-danger">{{ $message }}</p>
              @enderror
